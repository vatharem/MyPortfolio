...
const Contact = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // Optional: store messages in localStorage for admin view
        ...
        <div className="row align-items-start g-4">
          ...
          <div className="col-md-8">
            <form className="p-4 rounded-4 shadow-lg" onSubmit={handleSubmit} style={{ background: "rgba(13,17,23,0.8)", border: "1px solid rgba(0,191,255,0.3)" }}>
              <div className="mb-3">
                <label htmlFor="name" className="form-label fw-semibold text-info">Your Name</label>
              ...
              <div className="mb-3">
                <label htmlFor="email" className="form-label fw-semibold text-info">Email address</label>
              ...
              <div className="mb-3">
                <label htmlFor="message" className="form-label fw-semibold text-info">Message</label>
